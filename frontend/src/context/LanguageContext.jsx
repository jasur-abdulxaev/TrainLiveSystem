...
export const translations = {
  en: {
    ...
    // New additions
    realTime: 'REAL TIME',
    busSim: 'Bus Simulation',
    route83Dynamic: 'Route 83 · Dynamic Schedule',
    peakTime: 'Peak Time!',
    currentBuses: 'Current Buses',
    bus: 'buses',
    currentInterval: 'Current Interval',
    minute: 'minutes',
    maxBusesTitle: 'Max Buses',
    hour: 'hour',
    person: 'pass',
    nomCap: 'Nominal Capacity (qH)',
    peakCap: 'Peak Capacity',
    turnTime: 'Turnaround Time (tob)',
    coef: 'Coefficient (γ)',
    maxIntDay: 'Max. Interval (Day)',
    maxIntNight: 'Max. Interval (Night)',
    dispatchTab: 'Dispatch',
    tabloTab: 'Board',
    flowTab: 'Pass Flow',
    grafikTab: 'Graph',
    currentHourLegend: 'Current Hour',
    peakTimeLegend: 'Peak Time',
    normalTimeLegend: 'Normal Time',
    currentDispatch: 'Current Dispatch',
    scheduleBoard: 'Schedule Board',
    thBus: 'Bus',
    thTime: 'Time',
    thInterval: 'Interval',
    thBusCount: 'Bus Count',
    thStatus: 'Status',
    statDeparted: 'DEPARTED',
    statMoving: 'MOVING',
    statSoon: 'SOON',
  ...
  ru: {
    ...
    busSim: 'Симуляция Автобусов',
    route83Dynamic: 'Маршрут 83 · Динамическое Расписание',
    peakTime: 'Час Пик!',
    currentBuses: 'Текущие автобусы',
    bus: 'автобусов',
    currentInterval: 'Текущий интервал',
    minute: 'минут',
    maxBusesTitle: 'Макс. автобусов',
    hour: 'час',
    person: 'чел',
    nomCap: 'Номин. вместимость (qH)',
    peakCap: 'Вместимость (Пик)',
    turnTime: 'Время оборота (tоб)',
    coef: 'Коэффициент (γ)',
    maxIntDay: 'Макс. интервал (День)',
    maxIntNight: 'Макс. интервал (Ночь)',
    dispatchTab: 'Диспетчер',
    tabloTab: 'Табло',
    flowTab: 'Пасс. поток',
    grafikTab: 'График',
    currentHourLegend: 'Текущий час',
    peakTimeLegend: 'Час пик',
    normalTimeLegend: 'Обычное время',
    currentDispatch: 'Текущий диспетчер',
    scheduleBoard: 'Табло расписания',
    thBus: 'Автобус',
    thTime: 'Время',
    thInterval: 'Интервал',
    thBusCount: 'Кол-во авт.',
    thStatus: 'Статус',
    statDeparted: 'УШЕЛ',
    statMoving: 'В ПУТИ',
    statSoon: 'СКОРО',
    statScheduled: 'ПО РАСПИСАНИЮ',
    unitAvt: 'авт',
    unitMin: 'мин',
    unitPassH: 'пасс/ч',
    badgePeak: 'ПИК',
    badgeNow: 'СЕЙЧАС',
    mapNav: 'НАВИГАЦИЯ КАРТЫ',
    sysStatus: 'Система: Активна',
    location: 'Позиция',
    destination: 'Назначение',
    targetAB: 'Цель А→Б',
    returnBA: 'Возврат Б→А',
    volume: 'Объем',
    units: 'Единицы'
  }
};
